...
public class Survival implements ModInitializer {
	...
	private static void makeBoss_skeleton(SkeletonEntity skeleton) {
		...
		skeleton.getCommandTags().add("skeleton_boss");
	...
	private static void makeBoss_zombie(ZombieEntity zombie) {
		...
		zombie.getCommandTags().add("zombie_boss");
	...
	private static void makeBoss_blaze(BlazeEntity blaze) {
		...
		blaze.getCommandTags().add("blaze_boss");
	...
	private static void makeBoss_iron_golem (IronGolemEntity ironGolem) {
		...
		ironGolem.getCommandTags().add("Iron_golem_boss");
	...
	private static void makeBoss_enderman (EndermanEntity enderman) {
		...
		enderman.getCommandTags().add("enderman_boss");
	...
	private static void makeBoss_shulker (ShulkerEntity shulker) {
		...
		shulker.getCommandTags().add("Shulker_boss");
...
//hardcore_plus
		ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
			if (entity instanceof ZombieEntity zombie) {
				if (zombie.getCommandTags().contains("zombie_boss")) {
					makeBoss_zombie(zombie);
				}
			}
		});
		...
		ServerEntityEvents.ENTITY_LOAD.register((entity, serverWorld) -> {
			...
			if (entity instanceof ZombieEntity zombie)
				zombie.equipStack(EquipmentSlot.MAINHAND, new ItemStack(Items.NETHERITE_SWORD));
			if (entity instanceof ZombieEntity zombie)
				zombie.equipStack(EquipmentSlot.OFFHAND, new ItemStack(Items.BEACON));
			if (entity instanceof ZombieEntity zombie)
			...
			if (entity instanceof SkeletonEntity skeleton)
				skeleton.equipStack(EquipmentSlot.OFFHAND, new ItemStack(Items.ENCHANTED_GOLDEN_APPLE));
		...
		ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
			if (entity instanceof SkeletonEntity skeleton) {
				if (skeleton.getCommandTags().contains("skeleton_boss")) {
					makeBoss_skeleton(skeleton);
				}
			}
		});
		...
		ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
			if (entity instanceof BlazeEntity blaze) {
				if (blaze.getCommandTags().contains("blaze_boss")) {
					makeBoss_blaze(blaze);
				}
			}
		});
		...
		ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
			if (entity instanceof IronGolemEntity iron_golem) {
				if (iron_golem.getCommandTags().contains("Iron_golem_boss")) {
		...
		ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
			if (entity instanceof EndermanEntity enderman) {
				if (enderman.getCommandTags().contains("enderman_boss")) {
					makeBoss_enderman(enderman);
				}
			}
		});
		...
		ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
			if (entity instanceof ShulkerEntity shulker) {
				if (shulker.getCommandTags().contains("Shulker_boss")) {
					makeBoss_shulker(shulker);
				}
			}
		});
		...
		TradeOfferHelper.registerVillagerOffers(ModVillagers.NETHERALDER_KEY, 1, factories -> {
			factories.add((world, entity, random) -> new TradeOffer(
					new TradedItem(Items.EMERALD, 3),
					new ItemStack(ModItems.NETHER_EMERALD_SHARD, 1), 4, 7, 0.04f));

			factories.add((world, entity, random) -> new TradeOffer(
					new TradedItem(Items.EMERALD, 1),
					new ItemStack(ModItems.NETHER_EMERALD_CLUMP, 3), 4, 7, 0.04f));
		});

		TradeOfferHelper.registerVillagerOffers(ModVillagers.NETHERALDER_KEY, 2, factories -> {
			factories.add((world, entity, random) -> new TradeOffer(
			...
			factories.add((world, entity, random) -> new TradeOffer(
					...
					new ItemStack(ModBlocks.NETHER_EMERALD_BLOCK, 1), 64, 12, 0.09f));
		});

		TradeOfferHelper.registerVillagerOffers(ModVillagers.NETHERALDER_KEY, 3, factories -> {
			factories.add((world, entity, random) -> new TradeOffer(
					new TradedItem(ModItems.NETHER_EMERALD, 7),
					new ItemStack(ModBlocks.NETHER_EMERALD_FENCE, 1), 64, 7, 0.04f));

			factories.add((world, entity, random) -> new TradeOffer(
					new TradedItem(ModItems.NETHER_EMERALD, 8),
					new ItemStack(ModBlocks.NETHER_EMERALD_FENCE_GATE, 1), 64, 12, 0.09f));

			factories.add((world, entity, random) -> new TradeOffer(
					new TradedItem(ModItems.NETHER_EMERALD, 4),
					new ItemStack(ModBlocks.NETHER_EMERALD_PRESSURE_PLATE, 1), 64, 12, 0.09f));

		});

		TradeOfferHelper.registerVillagerOffers(ModVillagers.NETHERALDER_KEY, 4, factories -> {
			factories.add((world, entity, random) -> new TradeOffer(
			...
			factories.add((world, entity, random) -> new TradeOffer(
					new TradedItem(ModItems.NETHER_EMERALD, 2),
					new ItemStack(ModItems.NETHER_EMERALD_SWORD, 1), 3, 12, 0.09f));
		...
		TradeOfferHelper.registerVillagerOffers(ModVillagers.NETHERALDER_KEY, 5, factories -> {
			factories.add((world, entity, random) -> new TradeOffer(
					new TradedItem(ModItems.NETHER_EMERALD, 8),
					new ItemStack(ModItems.NETHER_EMERALD_HAMMER, 1), 1, 7, 0.04f));
			...
			factories.add((world, entity, random) -> new TradeOffer(
					new TradedItem(ModItems.NETHER_EMERALD, 2),
					new ItemStack(ModItems.EMERALD_COAL, 1), 64, 12, 0.09f));
			...
			factories.add((world, entity, random) -> new TradeOffer(
					...
					new ItemStack(ModItems.Healthy_Snack, 1), 64, 12, 0.09f));
