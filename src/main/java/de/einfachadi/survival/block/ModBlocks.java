...
public class ModBlocks {
    ...
    //ghost_blocks
    public static final Block NETHER_EMERALD_GHOST_BLOCK = registerBlock("nether_emerald_ghost_block", new Block(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Survival.MOD_ID, "nether_emerald_ghost_block"))).strength(4f).noCollision()));
   ...
   //normal blocks
    ...
    //special blocks
    public static final Block MAGICBLOCK = registerBlock("magic_block", new magic_block(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Survival.MOD_ID, "magic_block"))).strength(0.5f)));private static Block registerBlock(String name, Block block) {registerBlockItem(name, block);return Registry.register(Registries.BLOCK, Identifier.of(Survival.MOD_ID, name), block);}
    public static final Block netheriteingot_diamondapple = registerBlock("netheriteingot_diamondapple", new netheriteingot_diamondapple(AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(Survival.MOD_ID, "netheriteingot_diamondapple"))).strength(1f)));
